...
class Database {
  ...
  createAmbulanceRequest(requestData) {
    ...
    const request = {
      ...
      isSos: requestData.isSos || false,
      gpsLat: requestData.gpsLat || 21.1458,
      gpsLng: requestData.gpsLng || 79.0882,
      gpsAccuracy: requestData.gpsAccuracy || 10,
      driverName: 'Amit Sharma',
      driverPhone: '+91 98221 44550',
      driverRating: 4.9,
      paramedic: 'Dr. Neha Verma (ER Specialist)',
      etaMinutes: requestData.isSos ? 10 : 14,
      etaSeconds: requestData.isSos ? 600 : 892,
      initialEtaSeconds: requestData.isSos ? 600 : 1080,
      status: 'EN ROUTE',
